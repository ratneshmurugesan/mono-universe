export const getCursor = (hoveredItem: string, hoveredItemColor: string) =>
  ...
  <path d="M29.5 47C39.165 47 47 39.165 47 29.5S39.165 12 29.5 12 12 19.835 12 29.5 19.835 47 29.5 47z" fill="${hoveredItemColor}"/>
  </g>
  ...
  <tspan x="35" y="63">${hoveredItem}</tspan>
  </text>
  </g>
  <defs>
  <clipPath id="clip0">
